...
namespace LightingSystem.API.Features.HomeLightingSystem.Create
{
    public class AddLightSystemCommandHandler : IRequestHandler<AddLightSystemCommand,Guid>
    {
        ...
        public AddLightSystemCommandHandler(IHomeLightSystemRepository homeLightSystemRepository) => _homeLightSystemRepository = homeLightSystemRepository ?? throw new ArgumentNullException(nameof(homeLightSystemRepository));
